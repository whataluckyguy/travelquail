...
import { ProfileEditData, userProfileUpdate, profileDocument, profileTrip } from "../../redux/userProfile/actions"
...
const ProfileEdit = ({ history, ProfileEditDataAction, loading, selectedProfileData, userProfileUpdateAction, profileDocumentAction, profileDocTable, profileTripAction, profileTripTable }) => {
    ...
    const getEditData = () => {
        ProfileEditDataAction(id, history)
    }

    const profileDocData = () => {
        profileDocumentAction(id, history)
    }

    const profileTripData = () => {
        profileTripAction(id, history)
    }
    ...
    /* const flyers = selectedProfileData.frequentFlyer; */
    console.log("date ddd", moment(selectedProfileData.leaving_date))


    const initialValues = {
        id: selectedProfileData.id,
        user_id: selectedProfileData.user_id,
        title: selectedProfileData.title,
        first_name: selectedProfileData.first_name,
        middle_name: selectedProfileData.middle_name,
        last_name: selectedProfileData.last_name,
        company: selectedProfileData.company,
        department: selectedProfileData.department,
        joining_date: selectedProfileData.joining_date,
        leaving_date: selectedProfileData.leaving_date,
        rank: selectedProfileData.rank,
        employee_id: selectedProfileData.employee_id,
        company_number: selectedProfileData.company_number,
        personal_number: selectedProfileData.personal_number,
        company_email: selectedProfileData.company_email,
        personal_email: selectedProfileData.personal_email,
        emergency_name: selectedProfileData.emergency_name,
        emergency_number: selectedProfileData.emergency_number,
        frequentFlyer: selectedProfileData.frequentFlyer,
        travel_documents: selectedProfileData.travel_documents
    }
    ...
    const onSubmit = (values, { resetForm, setSubmitting }) => {
        ...
        if (!loading) {
            ...
            userProfileUpdateAction(values, history)
            console.log("hii")
            resetForm()
            setSubmitting(false);
        }
        ...
        confirmAlert({
            customUI: ({ onClose }) => {
                ...
                return (
                    <div className='custom-ui card-shadow'>
                        <h1>Are you sure?</h1>
                        <p>You want to switch to adding Trip ? Your Changes to profile will be lost!</p>
                        <Button type="button"
                            className="mr-2"
    ...
    return (
        <>
            <Row className="mb-4">
                <Colxx xxs="12" md="6">
                    <Card className="mb-5">
                        <CardBody>
                            <CardTitle>
                                <IntlMessages id="Edit your profile" />
                            </CardTitle>
                                            ...
                                            <Colxx xxs="6">
                                                <FormGroup className="form-group has-float-label">
                                                    ...
                                                    <FormikReactSelect
                                                        name="title"
                                                        id="title"
                                                        value={options.find(obj => obj.value === values.title)}
                                                        options={title}
                                            ...
                                            <Colxx xxs="6">
                                                <FormGroup className="form-group has-float-label">
                                                    ...
                                                    <FormikDatePicker
                                                        ...
                                                        onChange={setFieldValue}
                                                        maxDate={new Date()}
                                                        value={moment(values.joining_date).toDate()}
                                                    />
                                            ...
                                            <Colxx xxs="6">
                                                <FormGroup className="form-group has-float-label">
                                                    ...
                                                    <FormikDatePicker
                                                        ...
                                                        onBlur={setFieldTouched}
                                                        onChange={setFieldValue}
                                                        value={values.leaving_date ?moment(values.leaving_date).toDate(): null}
                                                    />
                                        ...
                                        <Row>
                                            <Colxx xxs="6">
                                                <FormGroup className="form-group has-float-label">
                                                    ...
                                                    />
                                                    {errors.company_number !== undefined ? (
                                                        <div className="invalid-feedback d-block">
                                            ...
                                            <Colxx xxs="6">
                                                <FormGroup className="form-group has-float-label">
                                                    ...
                                                    />
                                                    {errors.personal_number !== undefined ? (
                                                        <div className="invalid-feedback d-block">
                                        ...
                                        <Row>
                                            ...
                                            <Colxx xxs="6">
                                                <FormGroup className="form-group has-float-label">
                                                    ...
                                                    />
                                                    {errors.emergency_number !== undefined ? (
                                                        <div className="invalid-feedback d-block">
                                                            ...
                                                            frequentFlyer.map((f, index) => {
                                                                ...
                                                                return (
                                                                    <Fragment key={f}>
                                                                        ...
                                                                        <h4>Air miles / frequent flyer program {index + 1}</h4>
                                                                        <FormGroup className="form-group has-float-label">
                                                                            <Label>
                                                                ...
                                                                Update Frequent Flyer Details<sup> +</sup>
                                                            </Button>
                                                    ...
                                                    return (
                                                        travel_documents && travel_documents.length > 0 ?
                                                            travel_documents.map((doc, index) => {
                                                                ...
                                                                return (
                                                                    <Fragment key={doc}>
                                                                        {index===0?   <Button className="col-12 mb-3 mr-2" onClick={() => push({})}>Add travel document details</Button> :null}
                                                                        ...
                                                                        <Row>
                                                                            ...
                                                                            <Colxx xxs="6">
                                                                                <FormGroup className="form-group has-float-label">
                                                                                    ...
                                                                                    <CountryDropdown
                                                                                        name={`travel_documents[${index}].placeissuing_country`}
                                                                                        id="placeissuing_country"
                                                                                        className="form-control"
                                                                                        value={doc.placeissuing_country}
                                                                                        onChange={(val) => setFieldValue(`travel_documents[${index}].placeissuing_country`, val)}
                                                                                    />
                                                                                    {travelErrors.placeissuing_country && travelTouched.placeissuing_country ? (
                                                                                        <div className="invalid-feedback d-block">
                                                                                            {travelErrors.placeissuing_country}
                                                                                        </div>
                                                                                    ) : null}
                                                                            ...
                                                                            <Colxx xxs="6">
                                                                                <FormGroup className="form-group has-float-label">
                                                                                    ...
                                                                                    <FormikDatePicker
                                                                                        ...
                                                                                        value={moment(doc.issuing_date).toDate()}
                                                                                        onBlur={setFieldTouched}
                                                                                        onChange={setFieldValue}
                                                                                        maxDate={new Date()}
                                                                                        dateFormat="dd/MM/yyyy"
                                                                            ...
                                                                            <Colxx xxs="6">
                                                                                <FormGroup className="form-group has-float-label">
                                                                                    ...
                                                                                    <FormikDatePicker
                                                                                        ...
                                                                                        value={moment(doc.expiry_date).toDate()}
                                                                                        onBlur={setFieldTouched}
                                                                                        onChange={setFieldValue}
                                                                                        minDate={new Date()}
                                                                                        dateFormat="dd/MM/yyyy"
                                                                        ...
                                                                        <Row>
                                                                            ...
                                                                            <Colxx xxs="6">
                                                                                <FormGroup className="form-group has-float-label">
                                                                                    ...
                                                                                    <Field type="text" className="form-control" value={doc.pin_code} name={`travel_documents[${index}].pin_code`} />
                                                                ...
                                                                Update Travel Documents<sup> +</sup>
                                                            </Button>
                ...
                <Card >
                        <CardBody>
                            <CardTitle>
                                ...
                                <Button color="primary my-2" className="btn-block" onClick={() => setTripModal(true)}>
                                    Create New Trip<sup> +</sup>
                                </Button>
                                
                                <CustomTable columns={tripCol} data={profileTripTable} />
                            </CardTitle>
                        </CardBody>
                    </Card>
                    ...
                    <Card className="mt-5">
                        <CardBody>
                            <CardTitle>
                                <h3 className="text-center"  >Documents saved in this profile</h3><br />
                                <Button color="primary my-2" className="btn-block" onClick={ () =>setDocumentModal(true)}>
                                    Create New Document<sup> +</sup>
                                </Button>
                                <CustomTable columns={docCol} data={profileDocTable} />
                            </CardTitle>
                        </CardBody>
                    </Card>
            ...
            <TripModal isOpen={tripModal} toggle={() => setTripModal(!tripModal)} />
...
const mapStateToProps = ({ profileUser }) => {
    const { selectedProfileData, profileDocTable, profileTripTable, loading } = profileUser;
    console.log("selected doc table", profileTripTable)

    return { selectedProfileData, profileDocTable, profileTripTable, loading };

};
export default connect(mapStateToProps, { ProfileEditDataAction: ProfileEditData, userProfileUpdateAction: userProfileUpdate, profileDocumentAction: profileDocument, profileTripAction: profileTrip })(ProfileEdit);
