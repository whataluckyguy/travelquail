...
const ProfileForm = ({ props, history, userProfileAction, loading, }) => {
    ...
    const onSubmit = (values, { resetForm, setSubmitting }) => {
        ...
        // if (!loading && values.frequentFlyer.length === 0) {

        //     NotificationManager.warning("Please enter atleast one frequent flyer details", 'Add Frequent flyer', 3000, null, null, '');
        // } else if (values.travel_documents.length === 0) {
        //     NotificationManager.warning("Please enter atleast one travel document", 'Add travel document', 3000, null, null, '');
            ...
            <Row className="mb-4 d-flex justify-content-center">
                <Colxx xxs="12" md="7">
                    <Card className="mb-5">
                        <CardBody>
                            <CardTitle>
                                <IntlMessages id="Create new profile" />
                            </CardTitle>
                ...
                {/*  <Colxx xxs="12" md="6">
                    ...
                    <Card className="mt-5">
                        <CardBody>
                            <CardTitle>
                                <h3 className="text-center"  >Trips on Which these Profile are travelling</h3><br />
...
export default connect(mapStateToProps, { userProfileAction: UserProfile })(ProfileForm);
