...
const EntryRequirement = ({ history, allUserTripAction, userTrip, requestDataAction, reqData, requestUserAction, loading }) => {
                                                                ...
                                                                return (
                                                                    details && details.length > 0 ?
                                                                            ...
                                                                            if (values.travellers_ids.includes(p.profile_id)) {
                                                                                ...
                                                                                return (
                                                                                    <Fragment key={`p${index}`}>
                                                                                        ...
                                                                                        <h4 className="mt-2">Traveller(s) to Enter Requirement</h4>
                                                                                        <FormGroup className="form-group has-float-label">
                                                                                     ...
                                                                                     <p><i>We will revert with current travel restrictions / entry requirements for selected ‘sectors’ and ‘travellers’</i></p>
                                                                                    </Fragment>
                                                                                )
                                                                            }
                                                                        ...
                                                                        <Button className="btn-block" color="primary mb-3" onClick={()=>push({})}>
                                                                            Traveller(s) to enter requirements
                                                                    </Button>
...
export default connect(mapStateToProps, { allUserTripAction: allUserTrip, requestDataAction: requestData, requestUserAction: requestUser })(EntryRequirement)
