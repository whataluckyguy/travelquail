...
const Checkin = ({ history, allUserTripAction, userTrip, requestDataAction, reqData, requestUserAction, loading }) => {
   ...
   */
    ...
    const allTripData = () => {
        // const user_id = getCurrentUser().profile_id
    ...
    const initialValues = {
        ...
        details: reqData.profiles ? reqData.profiles.map(p =>
            ({ profile_id: p.id, profile_name: `${p.first_name} ${p.middle_name} ${p.last_name}`, travel_documents: "", frequent_flyer: "", seating_preference: "", priority_checkin: "", bags_to_check_in: "", special_request: "",notes:"", documents: docInsert(p.documents), flyer: flyerInsert(p.frequentFlyers) })
        ) : [],
            ...
            <Row className="mb-4">
                <Colxx md="5" xxs="12">
                    <Card className="mb-5">
                        <CardBody>
                            <CardTitle>
                                <IntlMessages id="Check-in Details" />
                            </CardTitle>
                                            ...
                                            <>
                                                ...
                                                <>
                                                    <FormGroup className="error-l-150 ">
                                                        <Label className="d-block">Select flight sector(s) for meal request</Label>
                                                        <FormikCheckboxGroup
                                                            inline
                                                            name="flight_ids"
                                                            id="flight_ids"
                                                ...
                                                <>
                                                    <FormGroup className="error-l-150 ">
                                                        <Label className="d-block">Select Travellers for checkin</Label>
                                                        <FormikCheckboxGroup
                                                            inline
                                                            name="travellers_ids"
                                                            id="travellers_ids"
                                                                            ...
                                                                            if (values.travellers_ids.includes(p.profile_id)) {
                                                                                ...
                                                                                return (
                                                                                    <Fragment key={`p${index}`}>
                                                                                        ...
                                                                                        <FormGroup className="form-group has-float-label">
                                                                                            <Label>
                                                                                                <IntlMessages id="Seating Preference" />
                                                                                            </Label>
                                                                                            <FormikReactSelect
                                                                                                name={`details[${index}].seating_preference`}
                                                                                                value={seatingOptions.find(obj => obj.value === p.seating_preference)}
                                                                                        ...
                                                                                        <FormGroup className="form-group has-float-label">
                                                                                            <Label>
                                                                                                <IntlMessages id="Priority check-in" />
                                                                                            </Label>
                                                                                            <FormikReactSelect
                                                                                                name={`details[${index}].priority_checkin`}
                                                                                                value={mealOptions.find(obj => obj.value === p.priority_checkin)}
                                                                                                options={mealOptions}
                                                                                                onChange={setFieldValue}
                                                                                                onBlur={setFieldTouched}
                                                                                            />
                                                                                        ...
                                                                                        <FormGroup className="form-group has-float-label">
                                                                                            <Label>
                                                                                                <IntlMessages id="Bags to Check In" />
                                                                                            </Label>
                                                                                            <FormikReactSelect
                                                                                                name={`details[${index}].bags_to_check_in`}
                                                                                                value={bagOptions.find(obj => obj.value === p.bags_to_check_in)}
                                                                                                options={bagOptions}
                                                                                                onChange={setFieldValue}
                                                                                                onBlur={setFieldTouched}
                                                                                            />
                                                                                        ...
                                                                                        <FormGroup className="form-group has-float-label">
                                                                                            <Label>
                                                                                                <IntlMessages id="Special Request" />
                                                                                            </Label>
                                                                                            <FormikReactSelect
                                                                                                name={`details[${index}].special_request`}
                                                                                                value={specialOptions.find(obj => obj.value === p.special_request)}
                                                                                      ...
                                                                                      <p><i>Please note: Preferences are not guaranteed and are subject to availability. Selections may be added/amended at the airport at the discretion of the airline. Some services/facilities may be chargeable in which case this will be communicated to you. If no selection is made, the default selection will be made as per the airline policy.</i></p>
...
export default connect(mapStateToProps, { allUserTripAction: allUserTrip, requestDataAction: requestData, requestUserAction: requestUser })(Checkin)
