   ...
   */
    ...
    const initialValues = {
        ...
        details: reqData.profiles ? reqData.profiles.map(p =>
            ({ profile_id: p.id, profile_name: `${p.first_name} ${p.middle_name} ${p.last_name}`, notes:"",meal_preference:"", documents: docInsert(p.documents), flyer: flyerInsert(p.frequentFlyers) })
        ) : [],
                                    ...
                                    <Form className="av-tooltip tooltip-label-bottom">
                                        ...
                                        {values.trip_id ?
                                            <>
                                                <FormGroup className="form-group has-float-label">
                                                    <Label>
                                                        <IntlMessages id="Company"  disabled/>
                                                    </Label>
                                                ...
                                                <>
                                                    <FormGroup className="error-l-150 ">
                                                        <Label className="d-block">Select travellers for meal request</Label>
                                                        <FormikCheckboxGroup
                                                            inline
                                                            name="travellers_ids"
                                                            id="travellers_ids"
                                                                            ...
                                                                            if (values.travellers_ids.includes(p.profile_id)) {
                                                                                ...
                                                                                return (
                                                                                    <Fragment key={`p${index}`}>
                                                                                        ...
                                                                                        <h4 className="mt-2">Traveller(s) to Meal request</h4>
                                                                                        <FormGroup className="form-group has-float-label">
