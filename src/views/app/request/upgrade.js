...
const Upgrade = ({ history, allUserTripAction, userTrip, requestDataAction, reqData, requestUserAction, loading }) => {
   ...
   */
    ...
    const flyerInsert = (flyers) => {
        ...
        flyers.forEach(fly => {
            flyerOptions.push({ id: fly.id, value: fly.flyer_number, label: fly.miles_program})
    ...
    const initialValues = {
        ...
        details: reqData.profiles ? reqData.profiles.map(p =>
            ({ profile_id: p.id, profile_name: `${p.first_name} ${p.middle_name} ${p.last_name}`,upgrade_option:"", flyer: flyerInsert(p.frequentFlyers) })
        ) : [],
    ...
    const Upgradedata = [
        { value: 'Paid upgrade', label: 'Paid upgrade' },
        { value: 'Miles upgrade', label: 'Miles upgrade', },
        { value: 'Part miles part cash upgrade', label: 'Part miles part cash upgrade' },
            ...
            <Row className="mb-4">
                <Colxx md="5" xxs="12">
                    <Card className="mb-5">
                        <CardBody>
                            <CardTitle>
                                <IntlMessages id="Upgrade request" />
                            </CardTitle>
                                            ...
                                            <>
                                                ...
                                                <>
                                                    <FormGroup className="error-l-150 ">
                                                        <Label className="d-block">Select flight sector(s) for upgrade request</Label>
                                                        <FormikCheckboxGroup
                                                            inline
                                                            name="flight_ids"
                                                            id="flight_ids"
                                                ...
                                                <>
                                                    <FormGroup className="error-l-150 ">
                                                        <Label className="d-block">Select travellers for upgrade request</Label>
                                                        <FormikCheckboxGroup
                                                            inline
                                                            name="travellers_ids"
                                                            id="travellers_ids"
                                                                            ...
                                                                            if (values.travellers_ids.includes(p.profile_id)) {
                                                                                ...
                                                                                return (
                                                                                    <Fragment key={`p${index}`}>
                                                                                        ...
                                                                                        <h4 className="mt-2">Traveller(s) to Upgrade</h4>
                                                                                        <FormGroup className="form-group has-float-label">
                                                                                        ...
                                                                                        */}
                                                                                        ...
                                                                                        <FormGroup className="form-group has-float-label">
                                                                                            ...
                                                                                            <FormikReactSelect
                                                                                                name={`details[${index}].upgrade_option`}
                                                                                        ...
                                                                                        { details[index].upgrade_option ==="Miles upgrade" ||details[index].upgrade_option ==="Part miles part cash upgrade"  
                                                                                        ?
                                                                                        <FormGroup className="form-group has-float-label">
                                                                                            <Label>
...
export default connect(mapStateToProps, { allUserTripAction: allUserTrip, requestDataAction: requestData, requestUserAction: requestUser })(Upgrade)
