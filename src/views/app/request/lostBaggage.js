...
const Lostbaggage = ({ history, allUserTripAction, userTrip, requestDataAction, reqData, requestUserAction, loading }) => {
   ...
   */
    ...
    const initialValues = {
        ...
        details: reqData.profiles ? reqData.profiles.map(p =>
            ({ profile_id: p.id, profile_name: `${p.first_name} ${p.middle_name} ${p.last_name}`,lost_bag: "",notes:"",  })
        ) : [],
            ...
            <Row className="mb-4">
                <Colxx md="5" xxs="12">
                    <Card className="mb-5">
                        <CardBody>
                            <CardTitle>
                                <IntlMessages id="‘Lost baggage request" />
                            </CardTitle>
                                            ...
                                            <>
                                                ...
                                                <>
                                                    <FormGroup className="error-l-150 ">
                                                        <Label className="d-block">Select flight sector(s) for lost baggage request</Label>
                                                        <FormikCheckboxGroup
                                                            inline
                                                            name="flight_ids"
                                                            id="flight_ids"
                                                ...
                                                <>
                                                    <FormGroup className="error-l-150 ">
                                                        <Label className="d-block">Select travellers for lost baggage request</Label>
                                                        <FormikCheckboxGroup
                                                            inline
                                                            name="travellers_ids"
                                                            id="travellers_ids"
                                                                            ...
                                                                            if (values.travellers_ids.includes(p.profile_id)) {
                                                                                ...
                                                                                return (
                                                                                    <Fragment key={`p${index}`}>
                                                                                        ...
                                                                                        <h4 className="mt-2">Traveller(s) Lost baggage</h4>
                                                                                        <FormGroup className="form-group has-float-label">
                                                                                        ...
                                                                                        <FormGroup className="form-group has-float-label">
                                                                                            <Label>
                                                                                                <IntlMessages id="Number of Lost Bag" />
                                                                                            </Label>
                                                                                            <FormikReactSelect
                                                                                                name={`details[${index}].lost_bag`}
                                                                                                value={specialOptions.find(obj => obj.value === p.lost_bag)}
                                                                                                options={bagOptions}
                                                                                                onChange={setFieldValue}
                                                                                                onBlur={setFieldTouched}
                                                                                            />
                                                                                        ...
                                                                                        <p><i>Please upload image of luggage tag / luggage claim form using the 'create new document' button</i></p>
                                                                                    </Fragment>
                                                                                )
                                                                            }
...
export default connect(mapStateToProps, { allUserTripAction: allUserTrip, requestDataAction: requestData, requestUserAction: requestUser })(Lostbaggage)
