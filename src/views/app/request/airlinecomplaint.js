...
const AirlineComplaint = ({ history, allUserTripAction, userTrip, requestDataAction, reqData, requestUserAction, loading }) => {
   ...
   */
    ...
    const initialValues = {
        ...
        details: reqData.profiles ? reqData.profiles.map(p =>
            ({ profile_id: p.id, profile_name: `${p.first_name} ${p.middle_name} ${p.last_name}`,complaint: "",notes:"",  })
        ) : [],
                                                                                ...
                                                                                return (
                                                                                    <Fragment key={`p${index}`}>
                                                                                        ...
                                                                                        <FormGroup className="form-group has-float-label">
                                                                                            ...
                                                                                            <FormikReactSelect
                                                                                                name={`details[${index}].complaint`}
                                                                                                value={options.find(obj => obj.value === p.complaint)}
                                                                                                options={options}
                                                                                                onChange={setFieldValue}
                                                                                                onBlur={setFieldTouched}
                                                                                            />
                                                                                        ...
                                                                                        <p><i>Please provide details in the notes section or please upload image of complaints form using the 'create new document' button</i></p>
                                                                                    </Fragment>
                                                                                )
                                                                            }
...
export default connect(mapStateToProps, { allUserTripAction: allUserTrip, requestDataAction: requestData, requestUserAction: requestUser })(AirlineComplaint)
