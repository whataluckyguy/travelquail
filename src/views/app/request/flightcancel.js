...
const FlightCancel = ({ history, allUserTripAction, userTrip, requestDataAction, reqData, requestUserAction, loading }) => {
   ...
   */
    ...
    const initialValues = {
        ...
        details: reqData.profiles ? reqData.profiles.map(p =>
            ({ profile_id: p.id, profile_name: `${p.first_name} ${p.middle_name} ${p.last_name}`, cancel: "",notes:"",  })
        ) : [],
                                            ...
                                            <>
                                                ...
                                                <>
                                                    <FormGroup className="error-l-150 ">
                                                        <Label className="d-block">Select flight sector(s) for complaint</Label>
                                                        <FormikCheckboxGroup
                                                            inline
                                                            name="flight_ids"
                                                            id="flight_ids"
                                                ...
                                                <>
                                                    <FormGroup className="error-l-150 ">
                                                        <Label className="d-block">Select travellers for complaint</Label>
                                                        <FormikCheckboxGroup
                                                            inline
                                                            name="travellers_ids"
                                                            id="travellers_ids"
                                                                            ...
                                                                            if (values.travellers_ids.includes(p.profile_id)) {
                                                                                ...
                                                                                return (
                                                                                    <Fragment key={`p${index}`}>
                                                                                        ...
                                                                                        <h4 className="mt-2">Traveller(s) to Cancel/Change flight</h4>
                                                                                        <FormGroup className="form-group has-float-label">
                                                                                        ...
                                                                                        {details[index].cancel === "Cancellation"?
                                                                                        <p><i>There may be a charge or penalty associated with cancelling this sector / ticket. If you are happy to accept the charges, please proceed to Submit</i></p>
                                                                                        :<p><i>Please provide details of preferred date / sector change. If the change is required for within the next 72 hours, please contact us via telephone on + 91 XXXXX XXXXX</i></p>
                                                                                    }
                                                                                    </Fragment>
                                                                                )
                                                                            }
...
export default connect(mapStateToProps, { allUserTripAction: allUserTrip, requestDataAction: requestData, requestUserAction: requestUser })(FlightCancel)
