...
const Specialrequest = ({ history, allUserTripAction, userTrip, requestDataAction, reqData, requestUserAction, loading }) => {
   ...
   */
    ...
    const initialValues = {
        ...
        details: reqData.profiles ? reqData.profiles.map(p =>
            ({ profile_id: p.id, profile_name: `${p.first_name} ${p.middle_name} ${p.last_name}`, travel_documents: "", frequent_flyer: "", seating_preference: "", priority_checkin: "", bags_to_check_in: "", special_request: "",notes:"",  })
        ) : [],
                                            ...
                                            <>
                                                ...
                                                <>
                                                    <FormGroup className="error-l-150 ">
                                                        <Label className="d-block">Select flight sector(s) for special request</Label>
                                                        <FormikCheckboxGroup
                                                            inline
                                                            name="flight_ids"
                                                            id="flight_ids"
                                                ...
                                                <>
                                                    <FormGroup className="error-l-150 ">
                                                        <Label className="d-block">Select travellers for special request</Label>
                                                        <FormikCheckboxGroup
                                                            inline
                                                            name="travellers_ids"
                                                            id="travellers_ids"
                                                                ...
                                                                return (
                                                                    details && details.length > 0 ?
                                                                            ...
                                                                            if (values.travellers_ids.includes(p.profile_id)) {
                                                                                ...
                                                                                return (
                                                                                    <Fragment key={`p${index}`}>
                                                                                        ...
                                                                                        <h4 className="mt-2">Traveller(s) to special Request</h4>
                                                                                        <FormGroup className="form-group has-float-label">
                                                                        ...
                                                                        <Button className="btn-block" color="primary mb-3" onClick={()=>push({})}>
                                                                            Traveller(s) to Special request
                                                                    </Button>
...
export default connect(mapStateToProps, { allUserTripAction: allUserTrip, requestDataAction: requestData, requestUserAction: requestUser })(Specialrequest)
